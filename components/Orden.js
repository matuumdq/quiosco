...
export default function Orden({orden}) {
  ...
  return (
    <div className="border p-10 space-y-5">
            ...
            <p className="text-2lg font-bold">Cliente: {nombre}</p>
            ...
            {pedido.map(plato => (
                <div key={plato.id} className='py-3 flex border-b last-of-type: border-0 items-center'>
                    ...
                    <div className="p-5 space-y-2">
                        ...
                        <p className="text-md font-bold">Cantidad: {plato.cantidad}</p>
                    </div>
                </div>
            ))}
        </div>
        <div className="md:flex md:items-center md:justify-between my-10">
                ...
                <button 
                    className="bg-indigo-600 hover:bg-indigo-800 text-white mt-5 md:mt-0 p-3 rounded-lg"
                    type="button"
